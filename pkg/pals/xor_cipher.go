...
func DecryptRepeatingKeyXor(b []byte) (Plain, Key, error) {
...
func DecryptRepeatingKeyXorWithKeysize(b []byte, Keysize int) (Plain, Key, error) {
	...
	return Plain{Plaintext: hplain}, decryptionKey, nil
}
